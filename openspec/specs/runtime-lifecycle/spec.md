...
The system MUST preserve legacy Claude hook/settings commands, Claude runtime lifecycle behavior, current OpenCode runtime lifecycle behavior, and current Codex runtime lifecycle behavior while adding Pi lifecycle support.
