...
6. Suggested delivery window — calendar time accounting for checkpoint round-trips and known session/rate-limit risk, not just compute time
7. Complexity
...
14. For completed work: Actuals and Calibration section with planned vs actual agent-compute-time, review time, post-review fix time, approval/cierre time, checkpoints actually hit, variance, and lessons learned
